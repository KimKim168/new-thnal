...
Route::middleware(['auth'])->group(function () {
    ...
    Route::delete('admin/libraries/files/{file}', [BanalaiLibraryController::class, 'destroy_file']);
    ...
    Route::delete('admin/resources/images/{image}', [ResourceController::class, 'destroy_image']);
    Route::post('admin/resources/{resource}/update', [ResourceController::class, 'update']);
    Route::post('admin/resources/{id}/recover', [ResourceController::class, 'recover']);
