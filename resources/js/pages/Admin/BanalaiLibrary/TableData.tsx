                            ...
                            >
                                ...
                                <TableCellActions>
                                    {item.deleted_at ? (
                                        ...
                                        <>
                                            {/* Edit Dialog */}
                                            <EditItemButton url={`/admin/libraries/${item.id}/edit`} permission="banalai_library update" />

                                            {/* View Dialog */}
                                            <ViewItemButton url={`/admin/libraries/${item.id}`} permission="banalai_library view" />

                                            {/* Delete Item */}
                                            <DeleteItemButton deletePath="/admin/libraries/" id={item.id} permission="banalai_library delete" />
                                        </>
                                    )}
                                </TableCellActions>
                                <TableCell>
